...
medium = tk.Button(root, text="średnie", width=20, height=2)
...
medhard = tk.Button(root, text="średnio-trudne", width=20, height=2)
...
hard = tk.Button(root, text="trudne", width=20, height=2)
